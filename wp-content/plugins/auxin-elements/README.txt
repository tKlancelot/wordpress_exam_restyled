...
>[Demo on Phlox Theme](http://phlox.pro "Live demo of Phlox Theme") | [Documentation](https://docs.phlox.pro/?utm_source=wporg-auxin-elements&utm_medium=wporg&utm_content=auxin-elements-doc&utm_term=documentation "Phlox Core Elements documentation") | [Video tutorials](https://www.youtube.com/playlist?list=PL7X-1Jmy1jcdekHe6adxB81SBcrHOmLRS "Watch all video tutorials") | [Support forum](http://help.averta.net/?utm_source=wporg-auxin-elements&utm_medium=wporg&utm_content=auxin-elements-supp&utm_term=support "Free support")
...
If you have any question about working with "Phlox Core Elements", you can take a look at [online documentations](https://docs.phlox.pro/?utm_source=wporg-auxin-elements&utm_medium=wporg&utm_content=auxin-elements-doc&utm_term=documentation)
...
If you get stuck you can [ask your question here](http://help.averta.net/).

= Will Phlox Core Elements work with my theme? =
No, Phlox Core Element only works on [Phlox Theme](http://phlox.pro/)

= Where can I report bugs? =
Bugs can be reported in our [support forums](https://docs.phlox.pro).
